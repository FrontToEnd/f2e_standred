...
## 类和构造器<a id="classes--constructors"></a>
...
## 迭代器和发生器<a id="iterators-and-generators"></a>
...
## 比较运算符和等号<a id="comparison-operators--equality"></a>
...
## 控制语句<a id="control-statements"></a>
...
## 类型转换和强制类型转换<a id="type-casting--coercion"></a>
...
## 命名规范<a id="naming-conventions"></a>
...
## ECMAScript 5 兼容性<a id="ecmascript-5-compatibility"></a>
